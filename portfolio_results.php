...
FROM budget_table WHERE MATCH(Portfolio) AGAINST('$portfolio' IN BOOLEAN MODE) GROUP BY Agency");//this query groups results triggered by user clicking on portfolio level url and shows all agencies within that portfolio with funding summed at agency level.
