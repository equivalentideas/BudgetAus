<?php include('scripts/header.php');?>
      ...
      <div id="blog" role="complimentary">
 	    ...
 	    <div class='featured'>
 	    <p>The biggest Programs and Schemes will have the biggest cuts in raw dollars. This query takes this into account and lists Schemes increases by the size relative to the prior year's funding.</p>
  </div>
...
<h5>This form gives Budget results from all fields eg immigration, schools.</h5>
    
    

  <form action='scheme_cuts_by_comparison.php' method="GET">
...
<a href='scheme_results.php?scheme=%22".mysql_result($scheme_results,$j, 'Objective')."%22'  target='_blank' title='Scheme Results for ".mysql_result($scheme_results,$j, 'Objective')."'>".mysql_result($scheme_results,$j, 'Objective')."</a>
</td>
