...
<td width='100px'>Personal Tax </td>
<td width='100px'>Other Taxes </td>
</tr>
<tr>
<td class='total'>
<span id='result_percentage'><b>".number_format($percent, 3)."%</b></span>
</td>
<td class='total'>
<b>$".number_format($billion, 3)." B</b>
</td>
<td class='total'>
<b>$".number_format($actual_PIT, 3)." B</b>
</td>
<td class='total'>
<b>$".number_format($acutal_TOS,3)." B</b>
</td>
</tr>
</table>";

//Other taxes includes Company tax
